...
2. `traefik.http.routers.traefik-secure.rule=Host(`traefik.domain.com`)`
    ...
    - Creates a router named “traefik-secure” that handles requests for the domain “traefik.domain.com”.
